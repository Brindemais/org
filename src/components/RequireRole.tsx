...
export function RequireRole({ roles, loginPath = '/entrar', children }: { roles: UserRole[]; loginPath?: string; children: ReactNode }) {
  ...
  if (!user || !profile) return <Navigate to={loginPath} replace />
